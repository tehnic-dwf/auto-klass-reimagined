          ...
          <div>
            ...
            <div className="mt-6 space-y-1 text-sm">
              ...
              <a
                ...
                className="flex min-h-11 items-center gap-3 text-primary-foreground/75"
              >
                ...
                {column.links.map((link) => (
                  <li key={`${column.title}-${link.label}`}>
                    <Link
                      ...
                      className="flex min-h-11 items-center text-primary-foreground/80 transition-colors hover:text-primary-foreground"
                    >
                      {link.label}
                    </Link>
                  </li>
